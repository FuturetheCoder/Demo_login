          ...
          child: new Column(
            ...
            children: <Widget>[
              ...
              Padding(
               ...
               new TextFormField(
                 autovalidateMode: AutovalidateMode.always, validator:(value) => value!.isEmpty ? "Email can\'t be empty" :null,
                decoration:new InputDecoration(
                  labelText: "EMAIL",
               ...
               new TextFormField(
                  autovalidateMode: AutovalidateMode.always, validator:(value) => value!.isEmpty ? "password can\'t be empty" :null,
                decoration:new InputDecoration(
                  labelText: "PASSWORD",
